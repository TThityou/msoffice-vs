...
*/
		...
		#define MSOC_DLL_EXPORT __cdecl
	#endif
#else
	#define MSOC_DLL_EXPORT
#endif
...
DLL_API const char * MSOC_DLL_EXPORT MSOC_getErrMessage(int err);
...
*/
DLL_API int MSOC_DLL_EXPORT MSOC_encrypt(const wchar_t *outFile, const wchar_t *inFile, const wchar_t *pass, const msoc_opt *opt);
/*
...
*/
DLL_API int MSOC_DLL_EXPORT MSOC_decrypt(const wchar_t *outFile, const wchar_t *inFile, const wchar_t *pass, msoc_opt *opt);
#endif
/*
	...
	use spinCount, secretKey of opt if set
*/
DLL_API int MSOC_DLL_EXPORT MSOC_encryptA(const char *outFile, const char *inFile, const char *pass, const msoc_opt *opt);
/*
	...
	opt is set by the value of inFile if opt is not NULL
*/
DLL_API int MSOC_DLL_EXPORT MSOC_decryptA(const char *outFile, const char *inFile, const char *pass, msoc_opt *opt);
...
/*
	...
	err if NULL
*/
DLL_API msoc_opt * MSOC_DLL_EXPORT MSOC_createOpt(void);
/*
	destroy msoc_opt
*/
DLL_API void MSOC_DLL_EXPORT MSOC_destroyOpt(msoc_opt *msoc);

/*
	get int value of optType of opt);
	@param value [out] return value
*/
DLL_API int MSOC_DLL_EXPORT MSOC_getInt(int *value, const msoc_opt *opt, int optType);
/*
	set int value of optType of opt
*/
DLL_API int MSOC_DLL_EXPORT MSOC_setInt(msoc_opt *opt, int optType, int value);
/*
	get string value of optType of opt
	@param str [out] return value
	@param maxSize [in] buffer size of str including '\0'
*/
DLL_API int MSOC_DLL_EXPORT MSOC_getStr(char *str, size_t maxSize, const msoc_opt *opt, int optType);
/*
	set string value of optType of opt
*/
DLL_API int MSOC_DLL_EXPORT MSOC_setStr(msoc_opt *opt, int optType, const char *str);
